            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if (
                    ...
                    if algorithm == "Insertion Sort":
                        start_time = time.time()
                        current_numswaps = insertion_sort(
                            win,
                            height,
                            color_height,
                            0,
                    ...
                    if algorithm == "Selection Sort":
                        start_time = time.time()
                        current_numswaps = selection_sort(
                            win,
                            height,
                            color_height,
                            0,
